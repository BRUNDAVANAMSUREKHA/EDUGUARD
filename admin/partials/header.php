        ...
        <div class="p-6">
            ...
            <nav>
                <ul>
                    ...
                    <li class="mb-4">
                        <a href="create_user.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-user-plus mr-2"></i>Create User
                        </a>
                    </li>
                    <li class="mb-4">
                        <a href="manage_users.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-users-cog mr-2"></i>Manage Users
                        </a>
                    </li>
                    <li class="mb-4">
                        <a href="create_course.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-book mr-2"></i>Create Course
                        </a>
                    </li>
                    <li class="mb-4">
