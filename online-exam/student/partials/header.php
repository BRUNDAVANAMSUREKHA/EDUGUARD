...
<body class="bg-gray-100">
    ...
    <div id="sidebar" class="bg-blue-600 text-white w-full md:w-64 fixed z-10 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out">
        <div class="p-6">
            <h1 class="text-2xl font-semibold text-center mb-6">Student Panel</h1>
            <nav>
                <ul>
                    <li class="mb-4">
                        <a href="dashboard.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-home mr-2"></i>Home
                        </a>
                    </li>
                    <li class="mb-4">
                        <a href="exam_list.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-user-plus mr-2"></i>All Exams
                        </a>
                    </li>
                    <li class="mb-4">
                        <a href="results.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                            <i class="fas fa-users-cog mr-2"></i>Results
                        </a>
                    </li>
                
                    <li class="mb-4">
                        <a href="logout.php" class="block py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
